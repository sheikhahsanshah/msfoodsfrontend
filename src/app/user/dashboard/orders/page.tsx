                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="space-y-3">
                                                {order.items.slice(0, 2).map((item) => {
                                                    ...
                                                    if (isDiscounted && order.couponUsed?.discountType === 'percentage') {
                                                        ...
                                                        <div key={item.product._id} className="flex items-center gap-4">
                                                            ...
                                                            <div className="text-sm text-right">
                                                                {isDiscounted && order.couponUsed?.discountType === 'percentage' ? (
                                                                    <>
                                                                        <p className="font-medium text-red-500">Rs. {finalPrice.toFixed(2)}</p>
                                                                        <p className="text-gray-400 line-through">Rs. {originalPrice.toFixed(2)}</p>
                                                                    </>
                                                                ) : (
                                                                    <p className="font-medium">Rs. {originalPrice.toFixed(2)}</p>
                                                                )}
                                                            </div>
                                                        </div>
                                                    )
                                                ...
                                                <div className="text-right">
                                                    {order.paymentMethod === 'COD' && order.codFee && order.codFee > 0 && (
                                                        <div className="text-xs text-orange-600 mb-1">
                                                            Includes COD fee: Rs. {order.codFee.toFixed(2)}
                                                        </div>
                                                    )}
