...
import { Edit, Trash2, Loader2, Upload, X, Search, Plus, Calendar } from "lucide-react"
                                ...
                                {filteredAds.length === 0 ? (
                                    ...
                                    filteredAds.map((ad) => (
                                        <TableRow key={ad._id}>
                                            ...
                                            <TableCell>
                                                <span
                                                    className={`px-2 py-1 rounded-full text-xs ${ad.isActive && isAdActive(ad) ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                                                        }`}
                                                >
                                            ...
                                            <TableCell className="text-right">
                                                ...
                                                <Button variant="ghost" size="icon" onClick={() => handleDeleteAd(ad._id)} disabled={isLoading}>
